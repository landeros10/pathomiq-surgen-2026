"""Attention entropy analysis functions — Phase 7 Step 6.
...
# ── Constants ──────────────────────────────────────────────────────────────────
ENTROPY_DIR = DEFAULT_FIGURES_DIR / "entropy"
...
# Alias for plan-spec function name
compute_run_entropies = collect_entropy_data


# ── Statistics ────────────────────────────────────────────────────────────────

def mann_whitney_entropy(st_entropies: list, mt_entropies: list) -> dict:
...
compute_mann_whitney = mann_whitney_entropy
...
def main() -> None:
    ...
    if rd_st is not None and rd_mt is not None:
        try:
            mw_result = mann_whitney_entropy(rd_st["entropies"], rd_mt["entropies"])

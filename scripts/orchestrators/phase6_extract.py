...
Usage:
    python scripts/orchestrators/phase6_extract.py --out-dir /tmp/phase6-data
    python scripts/orchestrators/phase6_extract.py --out-dir /tmp/phase6-data --skip-inference
"""

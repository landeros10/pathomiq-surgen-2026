...
def _section_deletion(lines: list) -> None:
    ...
    lines += [
        ...
        "Iteratively physically remove the top-k% most important patches from the bag",
        "(reducing bag size) at k ∈ {0, 5, 10, 20, 30, 50}%.",
        ...
        "",
        "**Insertion curve:**",
        "Start from a single highest-attribution real patch. Iteratively _add_",
        "patches in descending attribution order (growing the bag with real embeddings).",
        "An attribution method that correctly identifies the most important patches will",
        "cause the prediction to rise quickly.",
        ...
        "  prediction even after adding 50% of patches, the top-ranked patches may not",
        "  be the primary drivers — consider whether attribution scores are diffuse.",

...
Usage examples:
    ...
    python scripts/studies/phase7_run_all.py
    ...
    python scripts/studies/phase7_run_all.py --steps 4 --force \\
        --gcp-host 136.109.153.16 --gcp-user chris --gcp-pass 'chris@7yz'

    # Visualise-only for a single step (no GCP)
    python scripts/studies/phase7_run_all.py --steps 4 --visualise-only

    # Force re-run all steps
    python scripts/studies/phase7_run_all.py --force \\
        --gcp-host 136.109.153.16 --gcp-user chris --gcp-pass 'chris@7yz'
"""
